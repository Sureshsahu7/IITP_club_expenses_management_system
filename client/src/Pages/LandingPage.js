        ...
        >
          <div className="flex">
            <h1 className="text-rp-yellow text-3xl font-semibold pt-4">
              IITP Clubs Expenses Management System
            </h1>
            <button
      ...
      <div className="lg:grid lg:grid-cols-2 text-slate-300 lg:h-5/6 mt-32 lg:mt-0">
        <div className="my-auto">
          <div className="lg:text-6xl lg:py-3 text-2xl p-1">
            Clubs Expenses Management System of{" "}
            <span className="text-mj-yellow underline">IIT Patna</span>{" "}
            that tracks all expenses
          </div>
          <div className="lg:text-2xl py-2 text-xl mt-4">
            Track funds usage in all clubs...
          </div>
          {props.isLoggedIn ? (
            <button
              onClick={() => {
